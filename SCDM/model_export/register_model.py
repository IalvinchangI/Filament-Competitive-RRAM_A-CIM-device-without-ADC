...
# ==============================================================================
@ModelImportHandler.register_model("NLP_BitNet_2B4T_TNN")
def import_nlp_tnn():
    print(f"\n[NLP] Initializing BitNet b1.58 (TNN)...")
    try:
        try:
            weights_path = ModelImportHandler.MODEL_DEFAULT_DIR / "BitNet_2B4T.safetensors"

            print(f" -> Attempting to download REAL weights.")
            model = get_TernaryBitNet(str(weights_path), ModelImportHandler.DEVICE)
